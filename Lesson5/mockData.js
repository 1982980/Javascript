...
//TODO method sort() with string/ I can make additional checkup case

// const sortMethod = mockData.sort(function (a, b) {
//   let x = a.first_name;
//   let y = b.first_name;
...
//TODO method reduce(). Made new array with property age, then use method reduce

// const newArray = [...mockData];
// const addAge = newArray.forEach((element) => {
//   let age = Math.floor(Math.random() * 10);
//   element.age = age;
// });
//
// const sumAge = newArray.reduce((acc, item) => {
//   acc.age += item.age;
//   return acc;// TODO I can't show it in new object
// });
// console.log(sumAge);

//TODO method flat() I haa some problems with array)

console.log(mockData.flat());
